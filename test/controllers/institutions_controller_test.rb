...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { Nom: @institution.Nom, adresses_id: @institution.adresses_id } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { Nom: @institution.Nom, adresses_id: @institution.adresses_id } }

...
class EmployeursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employeur" do
    assert_difference('Employeur.count') do
      post employeurs_url, params: { employeur: { Nom: @employeur.Nom, adresses_id: @employeur.adresses_id } }
    end
  ...
  test "should update employeur" do
    patch employeur_url(@employeur), params: { employeur: { Nom: @employeur.Nom, adresses_id: @employeur.adresses_id } }

...
class AdressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adress" do
    assert_difference('Adress.count') do
      post adresses_url, params: { adress: { CodePostal: @adress.CodePostal, NumeroCivique: @adress.NumeroCivique, Province: @adress.Province, Rue: @adress.Rue, Ville: @adress.Ville } }
    end
  ...
  test "should update adress" do
    patch adress_url(@adress), params: { adress: { CodePostal: @adress.CodePostal, NumeroCivique: @adress.NumeroCivique, Province: @adress.Province, Rue: @adress.Rue, Ville: @adress.Ville } }
